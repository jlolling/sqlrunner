 ...
 ************************************************************/
package sqlrunner.config.fontchooser;
...
public class JFontChooser extends JComponent {
	...
	protected class DialogOKAction extends AbstractAction {
		...
		protected DialogOKAction(JDialog dialog) {
			...
			putValue(Action.NAME, Messages.getString(ACTION_NAME));
		}
	...
	protected JDialog createDialog(Component parent) {
		...
		JDialog dialog = new JDialog(frame, Messages.getString("SelectFont"),
				true);
	...
	protected JPanel getFontFamilyPanel() {
		if (fontNamePanel == null) {
			...
			JLabel label = new JLabel(Messages.getString("FontName"));
	...
	protected JPanel getFontStylePanel() {
		if (fontStylePanel == null) {
			...
			JLabel label = new JLabel(Messages.getString("FontStyle"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getFontSizePanel() {
		if (fontSizePanel == null) {
			...
			JLabel label = new JLabel(Messages.getString("FontSize"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JTextField getSampleTextField() {
		if (sampleText == null) {
			...
			sampleText = new JTextField(Messages.getString("SampleString"));
	...
	protected String[] getFontStyleNames() {
		if (fontStyleNames == null) {
			...
			fontStyleNames[i++] = Messages.getString("Plain");
			fontStyleNames[i++] = Messages.getString("Bold");
			fontStyleNames[i++] = Messages.getString("Italic");
			fontStyleNames[i++] = Messages.getString("BoldItalic");
		}
